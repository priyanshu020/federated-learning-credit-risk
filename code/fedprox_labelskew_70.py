# ==========================================================
# fedavg_vs_fedprox_labelskew_70.py
# Federated Learning Comparison (70% Label Skew)
# ==========================================================
...
# ==========================================================
# NON-IID CLIENT CREATION (70% LABEL SKEW)
# ==========================================================
...
plt.title("Accuracy Comparison (70% Label Skew)")
plt.xlabel("Rounds")
plt.ylabel("Accuracy")
plt.legend()
plt.grid(True)
...
plt.title("Loss Comparison (70% Label Skew)")
plt.xlabel("Rounds")
plt.ylabel("Log Loss")
plt.legend()
plt.grid(True)
